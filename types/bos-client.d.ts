...
declare namespace BaiduBce.SDK {
    type BosHttpsEndpoint = 'https://bj.bcebos.com' | 'https://cn-n1.bcebos.com'
        | 'https://gz.bcebos.com' | 'https://hk.bcebos.com'
        | 'https://hkg.bcebos.com'| 'https://hk02.bcebos.com'
        | 'https://su.bcebos.com' | 'https://fsh.bcebos.com'
        | 'https://bd.bcebos.com' | 'https://hb-fsg.bcebos.com'
        | 'https://fwh.bcebos.com' | 'https://sin.bcebos.com'
        | 'https://bjfsg.bcebos.com' | 'https://gz.bcebos.com';

    /** 🦦百度智能云 `BOS` 服务客户端 */
    export class BosClient {
        constructor(options: {endpoint: BosHttpsEndpoint} & Credentials);
         ...
         */
        putBucketReplication(): Promise<any>;
         ...
         */
        getBucketReplication(): Promise<any>;
         ...
         */
        deleteBucketReplication(): Promise<any>;
         ...
         */
        getBucketReplicationProgress(): Promise<any>;
         ...
         */
        deleteBucketLogging(): Promise<any>;
         ...
         */
        putBucketLifecycle(): Promise<any>;
         ...
         */
        getBucketLifecycle(): Promise<any>;
         ...
         */
        deleteBucketLifecycle(): Promise<any>;
         ...
         * [更多文档](https://cloud.baidu.com/doc/BOS/s/4jwvysf0k#deletebucketlifecycle%E6%8E%A5%E5%8F%A3)
         */
        putBucketStorageclass(): Promise<any>;
         ...
         */
        getBucketStorageClass(): Promise<any>;
         ...
         */
        putBucketEncryption(): Promise<any>;
         ...
         */
        getBucketEncryption(): Promise<any>;
         ...
         */
        deleteBucketEncryption(): Promise<any>;
         ...
         */
        putBucketStaticWebsite(): Promise<any>;
         ...
         */
        getBucketStaticWebsite(): Promise<any>;
         ...
         */
        deleteBucketStaticWebsite(): Promise<any>;
         ...
         */
        putBucketCopyrightProtection(): Promise<any>;
         ...
         */
        getCopyrightProtection(): Promise<any>;
         ...
         */
        deleteCopyrightProtection(): Promise<any>;
         ...
         */
        deleteMultipleObjects(): Promise<any>;
