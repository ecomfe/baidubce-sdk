...
function execute() {
  ...
  glob('src/bce-sdk-js/docs/*.*', function(er, files) {
  ...
  glob(MD_DIR + '**/*.*', function (er, files) {
    files.forEach(function(file) {
      ...
      if (extension === '.md' || extension === '.markdown') {
        ...
        var targetFile = 'src/bce-sdk-js/' + metadata.permalink.replace(/\.html$/, '.js');
  ...
  // fs.writeFileSync('src/bce-sdk-js/lib/Draft.css', fs.readFileSync('../dist/Draft.css'));
  // fs.writeFileSync('src/bce-sdk-js/lib/Draft.js', fs.readFileSync('../dist/Draft.js'));
  // fs.writeFileSync('src/bce-sdk-js/lib/RichEditor.css', fs.readFileSync('../examples/rich/RichEditor.css'));
