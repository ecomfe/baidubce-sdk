...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"advanced-topics-programming-style","title":"多种异步编程风格","layout":"docs","category":"Advanced Topics","next":"advanced-topics-postobject","permalink":"docs/advanced-topics-programming-style.html"}}>{content}</Layout>;
  }
});
module.exports = Post;
