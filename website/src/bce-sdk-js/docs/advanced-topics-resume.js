...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"advanced-topics-resume","title":"分块上传进阶 - “断点续传”","layout":"docs","category":"Advanced Topics","next":"advanced-topics-uploader","permalink":"docs/advanced-topics-resume.html"}}>{content}</Layout>;
  }
});
module.exports = Post;
