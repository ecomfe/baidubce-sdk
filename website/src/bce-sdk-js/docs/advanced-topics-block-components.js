...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"advanced-topics-block-components","title":"服务端动态签名","layout":"docs","category":"Advanced Topics","next":"advanced-topics-inline-styles","permalink":"docs/advanced-topics-block-components.html"}}>{content}</Layout>;
  }
});
module.exports = Post;
