...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"advanced-topics-postobject","title":"IE低版本的处理","layout":"docs","category":"Advanced Topics","next":"api-reference-bos","permalink":"docs/advanced-topics-postobject.html"}}>{content}</Layout>;
  }
});
module.exports = Post;
